...
public class ProblemOccurrence {
	 ...
	 */
	@JsonProperty(value = "rootCauseList")
	...
	public ProblemOccurrence(final InvocationSequenceData requestRoot, final double requestRootDuration, final InvocationSequenceData globalContext, final InvocationSequenceData problemContext,
			final List<RootCause> rootCauseList, final CauseStructure causeStructure) {
	...
	/**
	 * Gets {@link #rootCauseList}.
	 *
	 * @return {@link #rootCauseList}
	 */
	public final List<RootCause> getRootCauseList() {
		return this.rootCauseList;
	}

	/**
	 * Sets {@link #rootCauseList}.
	 *
	 * @param rootCauseList
	 *            New value for {@link #rootCauseList}
	 */
	public final void setRootCauseList(List<RootCause> rootCauseList) {
		this.rootCauseList = rootCauseList;
	}
	...
	public int hashCode() {
		...
		result = (prime * result) + ((this.rootCauseList == null) ? 0 : this.rootCauseList.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (this.rootCauseList == null) {
			if (other.rootCauseList != null) {
				return false;
			}
		} else if (!this.rootCauseList.equals(other.rootCauseList)) {
			return false;
		}
		return true;
	}
