...
public class InvocationIdentifier {
	...
	private final TimerDataProblemOccurrence timerDataProblemOccurence;
	...
	public InvocationIdentifier(final InvocationSequenceData invocationSequenceData) {
		...
		this.timerDataProblemOccurence = new TimerDataProblemOccurrence(InvocationSequenceDataHelper.getTimerOrSQLData(invocationSequenceData));
	}
