...
public class DiagnosisServiceTest extends TestBase {
	...
	public static class Init extends DiagnosisServiceTest {
		...
		@Test
		public void initFailureWithRulesInPackageWithoutActionTag() {

			DiagnosisService diagnosisServiceWithRulesInPackageWithoutActionTag = new DiagnosisService(new ArrayList<String>() {
				/**
				 * Default Serial ID.
				 */
				private static final long serialVersionUID = 1L;
			...
			assertEquals(diagnosisServiceWithRulesInPackageWithoutActionTag.init(), false);
